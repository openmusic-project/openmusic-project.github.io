Navigation : [Previous](Note-Chord-Chord-seq "\(Harmonic Objects\)") | [Next](Polyphonic "\(Polyphonic Objects\)")
...
A voice is a melodic-rythmic line.
...
notes in the "midic" input. Otherwise, OM won't recognize the elements to be tied.
