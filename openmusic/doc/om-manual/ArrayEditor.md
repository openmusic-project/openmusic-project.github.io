Navigation : [Previous](ArrayObject "\(Class-Array Object\)") | [Next](ArrayTools "\(Class-ArrayTools\)")
...
*The class-array editor.[Zoom](../res/array-ed_scr_1.png "Zoom")*
...
To zoom in/out on a selected region - a  components subset - : use the ![](../res/zoom_icon.png) and ![](../res/resizecurs_icon.png) buttons of the palette.
...
[![](../res/option2_1.png)](../res/option2.png "Zoom")
