Navigation : [Previous](Recursion "\(Recursive Patches\)") | [Next](RecursiveTree "\(Recursive Trees\)")
...
[![Creating a recursion : a patch is dropped into its own editor.](../res/rec1_1.png)](../res/rec1.png "Cliquez pour agrandir")
...
```
  ...
  2. The  **=**  test returns **"nil"**  if n ≠ 1 . It returns **"t"** if n = 1. **This is the termination condition of the patch.**
