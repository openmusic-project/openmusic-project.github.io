Navigation : [Previous](CurvesAndFunctions "\(Curves and Functions\)") | [Next](MultiBPF "\(BPF/BPC-Libs\)")
...
![A break-point function defined by points \(0 0\), \(14 46\), \(43 9\), \(89 19\) and \(97 , -1\).](../res/function.png)
*A break-point function defined by points*` (0 0), (14 46), (43 9), (89 19) and (97 , -1)`.
  

  
![A break-point curve defined by points \(8,6\) \(90,41\) \(15,42\) and \(101,3\).](../res/curve.png)
...
The **BPF** or **BPC** points can be set by connecting lists of values to the "x-points" and "y-points" inputs, or with the [BPF/BPC editor](BPFEditors).
...
![Rounding or increasing precision of the point coordinates with "decimals".](../res/decimals.png)
