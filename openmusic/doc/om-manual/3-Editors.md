Navigation : [Previous](1-Play "\(Playback and Players\)") | [Next](4-ImportExport "\(Import/Export\)")
...
[![A List editor](../res/listeditor-2_1.png)](../res/listeditor-2.png "Cliquez pour agrandir")
...
![The default and specific score editors of the "note" class](../res/noteeditors.png)
