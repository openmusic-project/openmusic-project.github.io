Navigation : [Previous](StandardInputs "\(Standard Inputs\)") | [Next](Connections "\(Connections\)")
...
![The OM-ROUND function has one input by default and and two optional inputs.](../res/om-round-optionals.png)
...
[![The SORT-LIST function has one initial argument and three keyword arguments](../res/sort-list-inputs_1.png)](../res/sort-list-inputs.png "Cliquez pour agrandir")
