Navigation : [Previous](InstanceBoxes "\(Instance Boxes\)") | [Next](SlotsBox "\(Slots\)")
...
![](../res/global_icon.png)
*It can also be exported as a  **global variable** to a workspace where it will be stored in the  [ Globals package](Packages) of the Library ![](../res/green_icon.png). Global variable boxes are green.*
