Navigation : [Previous](OnListLoop "\(OnList Loop\)") | [Next](WhileLoop "\(While Loop\)")
...
value - starting point - **to  a maximum** value - ending point - **by a default step** of 1, and stops once the maximum value is exceeded.
