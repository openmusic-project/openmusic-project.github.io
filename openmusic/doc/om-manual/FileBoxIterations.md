Navigation : [Previous](ReadingWriting "\(Reading / Writing\)") | [Next](BasicObjects "\(Basic Tools\)")
...
[![Visualizing the resulting text in a textfile box – above – and in the textfile editor – below.](../res/filebox-textfile_1.png)](../res/filebox-textfile.png "Zoom")
...
Inputs are added or removed like in [OMLoop boxes](LoopGeneral) : press `alt` \+ `->` or `<-`.
...
The **pathname** returned by **Finally** can possibly be displayed in a  [text-view](TextBoxes) .
