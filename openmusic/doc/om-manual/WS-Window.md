Navigation : [Previous](Workspace "\(Workspace\)") | [Next](WS-Presentation "\(Presentation Options\)")


# The Workspace Window

Visual programming in OM generally starts with browsing the workspace window, in order to create and/or select programming items.
...
**Reminder:** The workspace window displays the items stored in the `Elements` sub folder of the [ `Workspace` ](Workspace\(s\)) folder.
...
Double click on the name or press `Enter` to edit it ![](../res/rename_icon.png) .
