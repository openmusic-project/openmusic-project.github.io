Navigation : [Previous](LoopIterators "\(Iterators\)") | [Next](OnListLoop "\(OnList Loop\)")
...
In Lisp, this means that **listloop** returns successive  **cadr**s[1] .

"By" can be replaced by another function  meant to return a smaller chunk of a list, such as :  **cddr** [1] or **nthcdr** for instance.

It can be either a function box on ["lambda" mode](LambdaMode), or a function name.
