Navigation : [Previous](FileBoxIntro "\(Introduction\)") | [Next](FileBoxIterations "\(Designing Iterations\)")
...
![Reading and collecting the contents of the six first lines in a file – loop from 0 to 5.](../res/6lines.png)
...
The  **file-eof-p** function is a predicate, which tests if a **streamfile** is at the end of the file.
...
[![As long as the predicate finds no streamfile, it returns "nil", and lines are collected.](../res/read-eof_1.png)](../res/read-eof.png "Zoom")
