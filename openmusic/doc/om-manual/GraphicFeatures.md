...
![Function boxes and factory boxes belonging to the "combinatorial" and "score" categories.](../res/funandfact-boxes.png)
...
)[Zoom](../res/boxesstyle_scr_1.png "Zoom ")
...
![The rotate function box, with the default appearance and with new appearance preferences.](../res/box-sizes.png)
...
A category of objects sharing common properties - characteristics and behavour. A class specifies the internal structure and behavour of an object. In OM, it is represented in a patch by a factory box that can produce an instance of a class.
