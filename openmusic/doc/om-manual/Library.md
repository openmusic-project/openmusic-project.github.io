Navigation : [Previous](WS-ImportExport "\(Import / Export\)") | [Next](Packages "\(Packages\)")

# Library


The Library window encloses the OM programming tools, which are organized in **packages** and  **sub packages** . They can be used in various OM documents. These tools are classes[1], functions[2] and methods[3], among which a number
...
behavior depending on a type of argument. Defining a generic function amounts to defining at least one method.
