Navigation : [Previous](1-Visualization "\(Visualization\)") | [Next](1-Play "\(Playback and Players\)")
...
![A note box has five inlets and outlets, a "self", and four other inlets, which correspond to the usual musical features or parameters of a note : midicents – pitch –, velocity – dynamics –, duration, midi channel.](../res/noteinputs.png)
...
![Building a chord with two of its parameters : a list of pitches \(6000 6800\) for C4 and G#4, and a list of note velocities – dynamics – \(100 50\).](../res/buildchord.png)
