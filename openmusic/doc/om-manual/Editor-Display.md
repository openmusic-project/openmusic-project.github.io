Navigation : [Previous](Editors-Prefs "\(Preferences\)") | [Next](Editor-Basics "\(Basic Editing\)")
...
The note editor menus and controls.[Zoom](../res/changegrade_scr_1.png "Zoom \(nouvelle fenêtre\)")
...
## Multiple Staves Configurations in Polyphonic Objects
