Navigation : [Previous](AbsInputBoxes "\(Input Boxes\)") | [Next](RecursivePatch "\(Recursion in OM\)")
...
**The "factorial" function** calculates the product of all  **positive** integers that are  **inferior or equal** to a given  n number. It is written
...
This allows to calculate all the combinatorial possibilities of *n* elements, such as, for instance, the calculation of all possible melodic combinations of a group of notes.
