Navigation : [Previous](3DC "\(3DC\)") | [Next](ClassArray "\(Array\)")
...
The  **3DC-Lib** objects is similar to a  BPC-Lib . As [for BPFs and BPCs](MultiBPF), collections of **3DC** objects can be created and stored in the  **3DC-lib** object.  
...
[![](../res/showall_1.png)](../res/showall.png "Zoom")
...
[![](../res/Switchto3D2_1.png)](../res/Switchto3D2.png "Zoom")
